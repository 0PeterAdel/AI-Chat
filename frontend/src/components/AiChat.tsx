                        ...
                        >
                            <AnimatePresence mode="popLayout">
                                    ...
                                    >
                                        ...
                                        <motion.div
                                            ...
                                            className={`max-w-xl rounded-3xl p-5 shadow-message text-base relative ${
                                                message.sender === 'user'
                                                    ? 'bg-gradient-user text-white rounded-br-lg'
                                ...
                                {isLoading && (
                                    ...
                                    >
                                        <div className="w-12 h-12 rounded-2xl bg-gradient-primary flex items-center justify-center flex-shrink-0 shadow-message animate-pulse">
                                            <CalendarDays size={20} className="text-primary-foreground" />
                                        </div>
                            ...
                            <div className="max-w-4xl mx-auto">
                                <div className="flex items-center gap-4 bg-muted/50 border border-chat-border rounded-3xl p-3 transition-all duration-300 focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary/50 backdrop-blur-sm">
                                    ...
                                    <motion.button
                                        ...
                                        className="p-4 bg-gradient-primary hover:shadow-glow disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none rounded-2xl transition-all duration-300 group"
                                    >
                                        {isLoading ? (
                                            <LoaderCircle size={22} className="animate-spin text-primary-foreground" />
                                        ) : (
